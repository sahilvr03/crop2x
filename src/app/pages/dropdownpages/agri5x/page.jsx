...
<section className="relative py-24 md:py-26 overflow-hidden">
  ...
  <div 
    ...
    style={{ backgroundImage: "url('/assets/agri.png')" }} // <-- apni image ka path yahan do
  />
  ...
  <div className="absolute inset-0 bg-gradient-to-br from-green-900/40 via-black/50 to-emerald-900/40" />
