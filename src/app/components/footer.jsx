...
const footerLinks = {
  ...
  solutions: [
    { name: "Sensor & IoT", href: "/pages/Solutions#sensor-iot-solutions" },
    { name: "Satellite Intelligence", href: "/pages/Solutions#satellite-intelligence-ag5x" },
    { name: "Smart Irrigation", href: "/pages/Solutions#smart-water-management" },
    { name: "Farm as a Service", href: "/pages/Solutions#farm-as-a-service-faas" },
  ],
  products: [
    { name: "Crop2X Sensor Probes", href: "/pages/Products#crop2x-sensor-probes" },
    { name: "Weather Tracker", href: "/pages/Products#weather-tracker" },
  ...
  support: [
    ...
    { name: "FAQs", href: "/pages/Resources#faqs" },
